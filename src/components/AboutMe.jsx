  ...
  return (
    <section id='about' className='about bg-primary d-flex flex-column align-center justify-center'>
        ...
        <div className='about-content d-flex align-center justify-center'>
            ...
            <p className='text-light'>Hello everyone, I'm Zulfa Fakaha. I'm a Computer science student at Amikom University Yogyakarta with special interest in website development, particularly in Front End. During my studies, i have learned HTML, CSS, Bootstrap, JavaScript, and React JS.</p>
        </div>
    </section>
  )
}
